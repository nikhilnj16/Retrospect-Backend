...
//import maatrum.valuation.valuation_backend.model.valuation.Users;
//import maatrum.valuation.valuation_backend.service.UserDetailsService;
...
public class CustomKeycloakAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        UserServiceImpl userDetailService = appCtx.getBean(UserServiceImpl.class);
    ...
    public String getToken(Object userPrincipal) {
        ...
        if (null != userPrincipal) {
            if (userPrincipal instanceof Jwt) {
                LOGGER.debug("Inside Keycloak Security Contact principal");
